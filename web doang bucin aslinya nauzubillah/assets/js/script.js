...
// Dirubah 
const pengirim = "Audric";
const nomorWa = "6289668068213" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = ` ya? Aku ramal, besok kamu bakal berangkat ke pondok. wkwk padahal baru kenalan 2 detik lalu yah, oh iya itu ada hadiah untuk kamu di bawah :)`;
...
hilang2.addEventListener('click', () => {
  window.location.href = '/Bungaaa/index.html';
})
